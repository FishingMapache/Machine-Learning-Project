There are two parts to this program. First we do the preprocessing of data. This is performed in the preprocess.py. To run this file, we need to ensure we have all the data provided.
